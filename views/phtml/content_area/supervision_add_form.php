...
?>
<form action="?cmd=AddSupervision" enctype="multipart/form-data" method="post">
	<fieldset>
		<legend>Add Supervision</legend>
		...
		<p class="button_row">
			<input name="execute" value="Add Supervision" type="submit"/>
		</p>
	</fieldset>
</form>